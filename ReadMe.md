...
It is used to find the closest match in the component or if it is nested in another Route.

2. How would you explain form validation to someone who has never programmed before?

Form Validation checks to seee if text inputted into the fields are valid entries. our in other words does what is being inputted make sense to the field it is related to.

3. In 1-2 sentences, define end to end testing.

End to End tests programatically act as a user to make sure that everything functions correctly. Or in other words make sure that the user will experience what they should.
